...
const portfolioProjects = [
  {
    ...
    gitHub: "https://github.com/mmtiwari222",
    ...
    <section className="pb-16 lg:py-24">
      <div className="container">
        <div className="flex justify-center">
          <p className="uppercase font-bold tracking-widest bg-gradient-to-r from-emerald-300 to-sky-400 text-center text-transparent bg-clip-text">
            Real-world Results
          </p>
        </div>
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div className="lg:pb-16">
                  ...
                  <div className="flex flex-col gap-4 mt-8 md:flex-row md:gap-8">
                    <a href={project.link}>
                      <button className="bg-white text-gray-950 lg:text-sm h-12 w-full md:w-auto px-6 lg:px-4 rounded-xl font-semibold inline-flex items-center justify-center gap-2">
